...
import { Stethoscope, ShieldCheck, Sparkles, ArrowUp, Loader2 } from "lucide-react";
...
export function ChatInterface() {
  ...
  return (
    <section className="flex h-full flex-col gap-4">
      <header className="flex items-center justify-between gap-3 rounded-3xl border border-emerald-200/70 bg-emerald-50 px-4 py-3 dark:border-emerald-900/60 dark:bg-emerald-950/40">
        ...
        <div className="flex items-center gap-1.5 rounded-full bg-emerald-600/10 px-3 py-1 text-xs font-medium text-emerald-900 dark:bg-emerald-400/10 dark:text-emerald-50">
