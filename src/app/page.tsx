...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col bg-slate-50 text-foreground dark:bg-slate-950 dark:text-slate-50 lg:h-screen lg:overflow-hidden">
      <main className="mx-auto flex w-full flex-1 flex-col gap-6 px-4 pb-10 pt-6 sm:px-6 sm:pb-8 sm:pt-8 lg:min-h-0 lg:px-8 xl:px-12 xl:gap-8">
        <div className="grid flex-1 gap-6 lg:min-h-0 lg:grid-cols-[400px_1fr_400px] xl:grid-cols-[460px_1fr_460px] 2xl:grid-cols-[minmax(500px,1fr)_minmax(600px,2fr)_minmax(500px,1fr)]">

          {/* Left Column: Branding and Info */}
          <aside className="flex flex-col gap-6 rounded-3xl border border-emerald-200/80 bg-white/90 p-5 shadow-sm backdrop-blur dark:border-emerald-900/70 dark:bg-slate-950/60 lg:overflow-y-auto lg:p-6 custom-scrollbar">
          ...
          <section className="flex flex-col min-h-[600px] lg:min-h-0 lg:overflow-hidden">
            <div className="flex h-full flex-col rounded-3xl bg-background/90 p-3 shadow-[0_18px_45px_rgba(15,118,110,0.13)] ring-1 ring-emerald-200/80 dark:bg-slate-950/80 dark:ring-emerald-900/80 lg:overflow-hidden">
              <ChatInterface />
            </div>
          </section>

          {/* Right Column: Important Disclaimers */}
          <aside className="flex flex-col gap-5 rounded-3xl border border-emerald-100/80 bg-white/85 p-5 text-sm text-slate-700 shadow-sm backdrop-blur dark:border-emerald-900/70 dark:bg-slate-950/70 dark:text-slate-200 lg:overflow-y-auto lg:p-6 custom-scrollbar">
            <div>
